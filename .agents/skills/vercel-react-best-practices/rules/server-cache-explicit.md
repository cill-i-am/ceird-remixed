...
Use source-level caches for shared, non-secret data that is safe across requests, such as public config, feature flag metadata, and static reference data. In this repo, prefer Effect cache utilities or a small bounded cache with a TTL.
