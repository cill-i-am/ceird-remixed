...
Use Suspense boundaries around route regions or lazy components whose data/code can load independently from the surrounding shell. In this repo, pair Suspense with TanStack Router pending UI, TanStack Query suspense queries, or `React.lazy`.
