...
Lazy-load large client components that are not needed on the first interaction. In this repo, use Vite-compatible `import()`, `React.lazy`, and TanStack Router route code splitting.
